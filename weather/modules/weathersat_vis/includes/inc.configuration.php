...
####################################################################################
  ...
  $Style = '
	...
	{
	  background: url("modules/weathersat_vis/images/previous.png") transparent no-repeat;
	}
	#weathersat .play
	{
	  background: url("modules/weathersat_vis/images/play.png") transparent no-repeat;
	}
	#weathersat .pause
	{
	  background: url("modules/weathersat_vis/images/pause.png") transparent no-repeat;
	}
	#weathersat .next
	{
	  background: url("modules/weathersat_vis/images/next.png") transparent no-repeat;
	}
  ';
